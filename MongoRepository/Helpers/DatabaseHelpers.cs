namespace RecommendIT.Common.Data.MongoRepository.Helpers
{
    using System;
    using System.Reflection;
    using MongoDB.Driver;
    using RecommendIT.Common.Data.MongoRepository.Attributes;

    internal static class DatabaseHelpers<T>
        where T : IEntity
    {
        /// <summary>
        ...
        {
            string collectionName = typeof(T).GetTypeInfo().BaseType == typeof(object) ?
        ...
        private static string GetConnectionNameFromInterface()
        {
            ...
            Attribute att = typeof(T).GetTypeInfo().GetCustomAttribute(typeof(ConnectionNameAttribute));
        ...
        private static string GetConnectionNameFromType()
        {
            ...
            // Check to see if the object (inherited from Entity) has a ConnectionName attribute
            Attribute att = entitytype.GetTypeInfo().GetCustomAttribute(typeof(ConnectionNameAttribute));
            if (att != null)
            {
